...
@endpush
@section('title', 'Non followback')
<!-- begin #content -->
<div class="content no_padding">
  <div class="alert alert-shadow alert-dismissable ">
    <div class="notification-info">
      <h2 class="page-header no_margin"><i class="fas fa-recycle header-icon"></i> Twitter non followback <small><i>list of users who doesn't follow you back</i></small></h2>
    </div>
  </div>
</div>
    ...
    <div class="{{ $userType == 'free' ? 'col-sm-10' : 'col-sm-12'}}">
      ...
      <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title">non followback</h4>
        </div>

        <div class="panel-body">
        	@include('notify.crud_notify')
          <div class="list_of_service">
            <twitter-get-load :type="{{json_encode('non-followback')}}"></twitter-get-load>
          </div>
        </div>
      </div>
      <!-- end panel -->
