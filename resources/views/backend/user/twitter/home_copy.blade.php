						...
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="user_chart">
									<daily-report-chart :setting="{{json_encode($userSetSetting)}}"></daily-report-chart>
								</div>
								<br>
								@endif
							</div>
							...
							<div class="col-lg-4">
								...
								<!-- @if(isset($premium) && $premium == true && count($userSetSetting) > 0 && count($userSetSetting->tags) > 0)
								...
								<div class="panel panel-info" data-sortable-id="index-1">
									...
									<div class="list-group">
										<?php 
											$tagsEx = explode(',', $userSetSetting->tags);
											$tags = json_decode($userSetSetting->tags);
										 ?>
										@foreach($tags as $tag)
