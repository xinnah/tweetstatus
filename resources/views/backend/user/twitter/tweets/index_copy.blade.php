      ...
      <div class="panel panel-inverse">
        <div class="panel-heading">
            <div class="panel-heading-btn">
              <a href="{{URL::to('twitter-tweets/create')}}" class="btn btn-sm btn-success">Create tweet</a>
        ...
        <div class="panel-body">
          ...
          <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">List of view</a>
            </li>
            <li class="nav-item">
          ...
          <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="calender" role="tabpanel" aria-labelledby="calender-tab">
              <div class="show">
                <tweet-calendar :tweets="{{json_encode($getTweets)}}"></tweet-calendar>
              </div>
            </div>
          </div>
        </div>
