...
<div class="content no_padding">
  <div class="alert alert-shadow alert-dismissable ">
    <div class="notification-info">
      <h2 class="page-header no_margin"><i class="fas fa-volume-off"></i> Twitter blocked <small><i>list of users you blocked</i></small></h2>
    </div>
  </div>
</div>
    ...
    <div class="{{ $userType == 'free' ? 'col-sm-10' : 'col-sm-12'}}">
      ...
      <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h4 class="panel-title">blocked</h4>
        </div>

        <div class="panel-body">
          <div class="list_of_service">
            <twitter-mute-block :getids="{{json_encode($getId)}}" :type="{{json_encode('blocked')}}"></twitter-mute-block>
          </div>
