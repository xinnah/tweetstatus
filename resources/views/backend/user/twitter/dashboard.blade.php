 ...
 ?>
		...
		<div id="content" class="content">
			...
			<div class="col-sm-12">
                ...
                <a href="{{URL::to('twitter-unfollowers')}}" class="ribbon ribbon-blue ribbon-shadow">View</a>
              </div>
							<div class="stats-icon stats-icon-lg"><i class="fas fa-unlink"></i></div>
							<div class="stats-content">
								<div class="stats-title uppercase">Unfollowers</div>
								<div class="stats-number">{{$unfollowersCount}}</div>
								<div class="stats-progress progress">
									<div class="progress-bar" style="width: {{$tUnfollowers}}%;"></div>
								</div>
								<div class="stats-desc"><span class="pull-left uppercase">change</span><span class="pull-right">{{$tUnfollowers}}%</span></div>
							</div>
						</div>
					</div>
					<!-- end col-3 -->
				...
				<div class="row">
					<div class="col-sm-9">
						<div class="row">
							...
							<div class="col-lg-4">
								...
								@endif
								@if($userType == 'free')
								<div class="panel panel-inverse" data-sortable-id="index-1" id="ads_vertical_home">
					...
					<div class="col-sm-3 no_padding">
						@if($userType == 'free')
						@include('backend.user.twitter.free.ads_300')
						@endif
