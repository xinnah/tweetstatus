...
<div class="content no_padding">
  <div class="alert alert-shadow alert-dismissable ">
    <div class="notification-info">
      <h2 class="page-header no_margin"><i class="fas fa-volume-off"></i> Twitter {{$title}} <small><i>list of users you {{$title}}</i></small></h2>
    </div>
  </div>
</div>
      ...
      <div class="panel panel-inverse">
        ...
        <div class="panel-body">
          <div class="list_of_service">
            <twitter-whiteblack-list :getids="{{json_encode($getList)}}" :type="{{json_encode($title)}}"></twitter-whiteblack-list>
          </div>
